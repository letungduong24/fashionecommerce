  ...
  return (
    <div className='px-8'>
            ...
            <div className="flex flex-wrap gap-2">
                {colors.map((color) => (
                    <button 
                        ...
                        className='w-8 h-8 rounded-full border-gray-500 border cursor-pointer transition-all duration-300 hover:scale-105'
                    >
                    </button>
                ))}
            </div>
        ...
        <div className="mb-6">
            ...
            <input type="range" min={0} max={100} name='priceRange' className='w-full h-2 bg-gray-300 rounded-lg appearance-none cursor-pointer'/>
